...
export default function MealModal({ open, openModal, meal }: ModalProps) {
      ...
      >
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0 ">
            ...
            >
              <Dialog.Panel className="relative  overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:w-full min-h-screen">
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  <button
                    ...
                    ref={cancelButtonRef}
                  >
                    <img src="/close-button.png" width={24} height={24} />
                  </button>
                </div>
                <MealCard meal={meal} />
              </Dialog.Panel>
